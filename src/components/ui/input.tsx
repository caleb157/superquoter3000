  ...
  ({ className, type, value, defaultValue, inputMode, onChange, onBlur, onFocus, ...props }, ref) => {
    ...
    return (
      <input
        ...
        className={cn(
          "flex h-9 w-full rounded-md border border-input bg-background px-2.5 py-1.5 text-[13px] leading-tight ring-offset-background transition-[border-color,box-shadow] file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground hover:border-ring/40 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:border-ring disabled:cursor-not-allowed disabled:opacity-50 md:text-[13px]",
          className,
        )}
        ref={ref}
