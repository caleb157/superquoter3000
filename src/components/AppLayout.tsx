...
import { Settings, LogOut, Package, ShoppingCart, FileText, ClipboardList, Menu, Users, Inbox, Package2, CheckSquare, BarChart3 } from 'lucide-react';
...
export const AppLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navItems = [
    { to: '/', label: 'Dashboard', icon: Inbox, show: isAdminOrTeam },
