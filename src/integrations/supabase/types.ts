  ...
  public: {
    Tables: {
      ...
      qc_guides: {
        ...
        Relationships: [
          {
            foreignKeyName: "qc_guides_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      qc_rows: {
        ...
        Relationships: [
          {
            foreignKeyName: "qc_rows_section_id_fkey"
            columns: ["section_id"]
            isOneToOne: false
            referencedRelation: "qc_sections"
            referencedColumns: ["id"]
          },
        ]
      }
      qc_sections: {
        ...
        Relationships: [
          {
            foreignKeyName: "qc_sections_guide_id_fkey"
            columns: ["guide_id"]
            isOneToOne: false
            referencedRelation: "qc_guides"
            referencedColumns: ["id"]
          },
        ]
      }
